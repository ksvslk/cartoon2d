...
![cartoon2d-screen](assets/cartoon2d-screen.png)
...
From the `src/cartoon2d` directory, first change to the `app` subdirectory:
...
runner = Runner(app_name="cartoon2d", agent=agent, session_service=session_service)
```
